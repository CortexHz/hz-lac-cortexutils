...
sets['Weapon']['Great Katana']['L65'] = {
    Main = 'Golden Spear',
    Sub = 'Pole Grip',
}
sets['Weapon']['Great Katana']['L60'] = {
    Main = 'Couse',
    Sub = 'Pole Grip',
}
sets['Weapon']['Great Katana']['L53'] = {
    Main = 'Thundercloud',
    Sub = 'Tenax Strap',
}
sets['Weapon']['Great Katana']['L49'] = {
    Main = 'Wind Spear',
    Sub = 'Tenax Strap',
}
sets['Weapon']['Great Katana']['L30'] = {
    Main = 'Ryl.Sqr. Halberd',
    Sub = 'Tenax Strap',
}
sets['Weapon']['Great Katana']['L18'] = {
    Main = 'Ryl.Spr. Spear',
    Sub = 'Tenax Strap',
}
sets['Weapon']['Great Katana']['L10'] = {
    Main = 'Katayama',
    Sub = 'Tenax Strap',
}
sets['Weapon']['Great Katana']['L07'] = {
    Main = 'Mumeito',
    Sub = 'Tenax Strap',
}
sets['Weapon']['Great Katana']['L01'] = {
    Main = 'Mumeito',
}
